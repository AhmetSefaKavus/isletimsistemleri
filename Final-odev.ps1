Get-ScheduledJob | Unregister-ScheduledJob -Force #Powershell için kayıtlı olan tüm schedule job'ları temizliyoruz.                                                            
...
$logfilepath="C:\Users\anant\Desktop\cıktı.txt" #Sonuçları yazdıracağımız dosya yolunu tanımladık.
